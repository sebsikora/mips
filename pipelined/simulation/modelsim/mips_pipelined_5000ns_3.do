...
update
WaveRestoreZoom {0 ps} {4693463 ps}
view wave 
...
wave modify -driver freeze -pattern constant -value 1 -starttime 0ns -endtime 1000ns Edit:/mips_pipelined/rst 
wave modify -driver freeze -pattern constant -value 0 -starttime 800ns -endtime 1000ns Edit:/mips_pipelined/rst 
WaveCollapseAll -1
